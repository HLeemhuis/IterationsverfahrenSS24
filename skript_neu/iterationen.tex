...
\usepackage{ngerman,                                      % ngerman für neue dt. Rechtschreibung
	         amssymb,                  
...
\usepackage[latin1]{inputenc}                           % um ß und Umlaute direkt benutzen zu können
...
\setlength{\headheight}{15pt}		               % Kopfhöhe
\setlength{\parindent}{0cm}		               % keinen Einzug
\renewcommand{\headrulewidth}{0.4pt}	   % obere Liniendicke
\lhead{\leftmark}				   % weitere Einstellungen für den Kopf-/Fußbereich
\rhead{\today}



\allowdisplaybreaks				   % Seitenumbruch in Formeln ermöglichen
\numberwithin{equation}{section}		   % Gleichung in einer section zurücksetzen
...
\renewcommand{\Leftrightarrow}{\Longleftrightarrow}		% sieht schöner aus
...
\usepackage{tikz}	%korrektur für Ellipsen. Stand 2024. Author Henning Leemhuis
