...
\begin{defn}
  ...
  Heutzutage (Sommer 2003) liegt $N$ zwischen $32$ und $128$.
  \begin{center}
...
\end{equation}
lösen mit $\Gamma_{\!5}$ einfache Permutations-Matrix,
...
\end{align*}
Dabei kann $T_{m,m}^{-1/2}$ f\"ur moderates $m$ explizit durch
...
Wir leiten zuerst die Abschätzung für die Residuen her:
...
für $s < 0$ und damit $|\Phi_{k,t}| < 1$. \medskip

Nun ist noch die Abschätzung zu beweisen. Dazu betrachtet man
\begin{eqnarray*}
...
$$
\frac{2}{\pi} \int_0^{\infty} \psi{t,m} Q(Q^2 + t^2I)^{-1} \, dt
$$
